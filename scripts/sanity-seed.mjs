...
const document = {
  ...
  accounts: [
    { _key: 'acct1', name: 'Advisory Account', accountNumber: '8478749874968', balance: 0, balanceLabel: 'Total Holdings', address: '123 Main St, Springfield, IL 62704', bank: 'First National Bank', routingNumber: '021000021', bankAddress: '456 Bank Ave, Chicago, IL 60601' },
    { _key: 'acct2', name: 'Cash Account', accountNumber: '5566778899001', balance: 0, balanceLabel: 'Available Balance', address: '123 Main St, Springfield, IL 62704', bank: 'Chase Bank', routingNumber: '021000015', bankAddress: '789 Commerce Blvd, New York, NY 10001' },
    { _key: 'acct3', name: 'Sovereign Gold Bond', accountNumber: '3344556677889', balance: 0, balanceLabel: 'Total Holdings', address: '123 Main St, Springfield, IL 62704', bank: 'Bank of America', routingNumber: '026009593', bankAddress: '321 Financial Dr, Charlotte, NC 28202' },
    { _key: 'acct4', name: 'International US Depot', accountNumber: '9988776655443', balance: 0, balanceLabel: 'Total Value (USD)', address: '123 Main St, Springfield, IL 62704', bank: 'Wells Fargo', routingNumber: '121000248', bankAddress: '555 Global St, San Francisco, CA 94105' },
  ],
  events: [
